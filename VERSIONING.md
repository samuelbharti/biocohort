...
- **PATCH** (0.1.2): Bug fixes, documentation updates, minor improvements
...
### MINOR (x.1.x → x.2.x)
- New functions added
- New parameters added to existing functions (with defaults to maintain backward compatibility)
- New features
