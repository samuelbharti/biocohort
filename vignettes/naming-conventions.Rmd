...
- **Study objects**: snake_case, descriptive (e.g., `my_study`, `nf1_study`) or explicitly named `study` in examples.
- **Cohort objects**: snake_case (e.g., `cohort`, `nf1_cohort`, `study_cohort`).
...
- **Raw data**: Use consistent prefix and descriptor (e.g., `manifest_nf1_001.csv`, `cohort_pilot_data.rda`)
