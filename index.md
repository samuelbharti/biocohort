...
Bioconductor already has `MultiAssayExperiment` for lining up data that
is already loaded. biocohort sits one step earlier, before anything is
loaded: the manifest, the file paths, the sample sheet, and the record
of every manual fix.
...
See
[CONTRIBUTING.md](https://github.com/samuelbharti/biocohort/blob/main/CONTRIBUTING.md)
for the development workflow.

## License

MIT. See
[LICENSE](https://github.com/samuelbharti/biocohort/blob/main/LICENSE).
