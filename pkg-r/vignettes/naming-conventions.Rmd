...
This document describes standardized naming conventions used in biocohort for data columns, R objects, functions, and file names.
...
While biocohort does not enforce specific sample ID formats, adopt a consistent project-wide convention. Encoding the assay and role in the ID can aid readability:
