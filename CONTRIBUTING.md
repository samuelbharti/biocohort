...
for the complete checklist of steps to follow after making changes.

**Quick summary:** 1. Make changes 2. `devtools::load_all()` - test
interactively 3. `devtools::test()` - run tests 4. `devtools::check()` -
validate package 5. Commit and push (website auto-updates)
...
The pkgdown website is automatically built via GitHub Actions when you
push to main.
